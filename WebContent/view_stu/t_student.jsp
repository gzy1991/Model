...
<div class="logo"></div>
  ...
  <div class="welcome">
	<span>老师:<%=member.getMemberName()%> 您好！</span><span><a>账号设置</a></span><span><a href="../login2/doLoginOut">注销</a></span>
  </div>
<div class="tab">
	<ul>
<!-- 		<li><a href="#" target="iframe">首页</a></li> -->
        <li><a id="#managerSelf" class="nav" href="t_student_personalInfor.jsp" target="iframe">个人管理</a></li>
	</ul>
</div>	
<hr/>
<div class="content" id="content">
	...
	<div class="menuList" id="managerSelf">
		<ul>
			<li>个人管理</li>
			<li><a href="t_student_personalInfor.jsp" target="iframe">个人信息</a></li>
			<li><a href="t_studentModify.jsp" target="iframe">修改信息</a></li>
...
function SetWinHeight(ob) {                     //自动调整iframe高度
	...
	<iframe class="iframe" src="t_student_personalInfor.jsp" name="iframe" scrolling="no" frameborder="no" onload="SetWinHeight(this)"></iframe>
</div>
<div class="footer">
